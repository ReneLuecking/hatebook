 ...
 */
class Version20180219082545 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE file ADD COLUMN mime_type VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, picture_id INTEGER DEFAULT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, email VARCHAR(255) NOT NULL COLLATE BINARY, birthday DATE NOT NULL, password VARCHAR(64) NOT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_8D93D649EE45BDBF FOREIGN KEY (picture_id) REFERENCES file (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_FB9F5AA97DB3B714 ON enemy (initiator_id)');
        $this->addSql('CREATE INDEX IDX_FB9F5AA9E92F8F78 ON enemy (recipient_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__file AS SELECT id, extension FROM file');
        $this->addSql('DROP TABLE file');
        $this->addSql('CREATE TABLE file (id INTEGER NOT NULL, extension VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO file (id, extension) SELECT id, extension FROM __temp__file');
        ...
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER NOT NULL, picture_id INTEGER DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(64) NOT NULL, birthday DATE NOT NULL, PRIMARY KEY(id))');
